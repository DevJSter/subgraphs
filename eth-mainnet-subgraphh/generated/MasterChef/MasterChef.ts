...
export class MasterChef extends ethereum.SmartContract {
  ...
  Obo(): Address {
    let result = super.call("Obo", "Obo():(address)", []);

    return result[0].toAddress();
  }

  try_Obo(): ethereum.CallResult<Address> {
    let result = super.tryCall("Obo", "Obo():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  OboPerBlock(): BigInt {
    let result = super.call("OboPerBlock", "OboPerBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_OboPerBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("OboPerBlock", "OboPerBlock():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getRefFriend(farmer: Address): Address {
    let result = super.call("getRefFriend", "getRefFriend(address):(address)", [
  ...
  try_getRefFriend(farmer: Address): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "getRefFriend",
      "getRefFriend(address):(address)",
      [ethereum.Value.fromAddress(farmer)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  pendingObo(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingObo",
      "pendingObo(uint256,address):(uint256)",
      [
  ...
  try_pendingObo(_pid: BigInt, _user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "pendingObo",
      "pendingObo(uint256,address):(uint256)",
      [
  ...
  referredCount(param0: Address): BigInt {
    let result = super.call(
      "referredCount",
  ...
  try_referredCount(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "referredCount",
      "referredCount(address):(uint256)",
      [ethereum.Value.fromAddress(param0)],
